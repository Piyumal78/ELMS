...
public interface LabReservationService {
    ...
    LabReservationResponseDto updateLabReservation(Long reservationId, LabReservationRequestDto labReservationRequestDto)
    ...
    List<LabReservationResponseDto> getLabReservationsByDate(LocalDate reservationDate) throws ResourceNotFoundException;

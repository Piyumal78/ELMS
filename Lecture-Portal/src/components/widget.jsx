  ...
  const Widget = ({ type, count }) => {
    ...
    // Widget configurations for different types
    switch (type) {
      case 'courses':
        data = {
          title: 'My Courses',
    ...
    return (
      <div className="bg-white border border-gray-200 rounded-lg p-5 hover:border-gray-300 transition-colors">
        <div className="flex items-start justify-between">
          ...
          <div className="w-10 h-10 bg-gray-50 border border-gray-100 rounded-lg flex items-center justify-center text-gray-400">
            {data.icon}
          </div>
        </div>
